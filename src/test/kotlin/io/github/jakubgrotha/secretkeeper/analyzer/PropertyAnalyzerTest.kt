...
class PropertyAnalyzerTest {
    ...
    fun `should correctly analyze single yaml file with no violations`() {
        ...
        // then
        assertThat(result).isInstanceOf(io.github.jakubgrotha.secretkeeper.analyzer.PropertyAnalyzer.AnalysisResult.Success::class)
    }
    ...
    fun `should correctly analyze single yaml file with violations`() {
        ...
        // then
        assertThat(result).isInstanceOf(io.github.jakubgrotha.secretkeeper.analyzer.PropertyAnalyzer.AnalysisResult.Failure::class)
    }
    ...
    fun `should correctly analyze multiple yaml files`() {
        ...
        // then
        assertThat(result).isInstanceOf(io.github.jakubgrotha.secretkeeper.analyzer.PropertyAnalyzer.AnalysisResult.Failure::class)
        val filesWithViolations = (result as io.github.jakubgrotha.secretkeeper.analyzer.PropertyAnalyzer.AnalysisResult.Failure).filesWithViolations
